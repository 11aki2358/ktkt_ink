...
このサイトを作る際に調べたこと・気づいたことの記録。  
メインのページは[ここ](../top.html)。
...
パソコンでサイトを作ってから公開・更新するまで。全て、完全に無料で開始・継続できる(有料オプションもあるけれど、使わなくても十分)。  
ホスティングには、NetlifyかVercelを利用。Firebaseについてのメモもある。
現在はVercelを使っている(2026.01)。

* [To Start] ざっくり概要 : [link](start.html)
...
* Headerの中身について : [link](design-header.html)
...
* サイト内の各パーツの見本 : [link](example.html)
* Backyardの記事のテンプレ(空ページ) : [link](template.html)

### Bookmark

よくお世話になるサイト
* [W3 School](./bookmark-W3-School.html)

### Markdown to html

サイト作成用

* Backyardの記事 : [link](./md-to-html-backyard.html)
* 機能について : [link](md-to-html.html)
* Markdownで遊ぶ : [link](markdownで遊ぶ.html)